...
def showImage():
    img = PhotoImage(file=r"MULTIMETER IMAGE PATH HERE")
...
label = Label(root, text="Enter yes if you would like to learn about multimeters. Press the X in the top right corner to exit.",)
label.grid()
